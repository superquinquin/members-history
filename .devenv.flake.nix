...
devenv_tmpdir = "/var/folders/jn/zt0yhngj7lx11pphrnj3wvn40000gn/T/";
devenv_runtime = "/var/folders/jn/zt0yhngj7lx11pphrnj3wvn40000gn/T/devenv-cedba05";
devenv_istesting = false;
devenv_direnvrc_latest_version = 1;
container_name = null;
active_profiles = [ ];
hostname = "MacBook-Air-de-REMI.local";
username = "remi";
